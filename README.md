...
[8/9] [Desenvolvimento Front-end](https://github.com/G-Alves1/Trybe/tree/main/02_Desenvolvimento-Front-end)
...
* Clone o repositório
  ```sh
    git clone git@github.com:G-Alves1/starwars-planets-search.git
  ```
